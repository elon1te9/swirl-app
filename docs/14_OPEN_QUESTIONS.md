...
3 predefined avatars.

Reason:

This matches the current seed data and is enough for registration and profile
customization in MVP.
...
For this project structure, request DTO models should be placed in `Requests`
and response DTO models should be placed in `Responses`.
